...
"""
경제 상식 RAG 시스템
ChromaDB와 OpenAI를 활용한 경제 상식 질의응답 시스템
"""
...
class FinanceRAGSystem:
    def __init__(self):
        ...
        self.chroma_client = chromadb.PersistentClient(
            path=os.path.join(self.base_dir, 'data', 'chroma_db'),
            settings=Settings(anonymized_telemetry=False)
        )
        
        # 컬렉션 생성 또는 가져오기
        try:
            self.collection = self.chroma_client.get_collection("finance_knowledge")
        except:
            self.collection = self.chroma_client.create_collection(
                name="finance_knowledge",
                metadata={"description": "경제 상식 지식베이스"}
            )
        ...
        return [
            {
                ...
                """,
                "category": "연금",
                "keywords": ["연금저축", "개인연금", "퇴직연금", "IRP", "연금보험", "세제혜택"]
            },
            {
                "id": "stock_investment",
                "title": "주식 투자",
                ...
                """,
                "category": "투자",
                "keywords": ["주식", "주식투자", "증권", "코스피", "코스닥", "ETF", "배당"]
            },
            {
                "id": "isa_account",
                ...
                """,
                "category": "투자",
                "keywords": ["ISA", "개인종합자산관리계좌", "세제혜택", "투자계좌", "포트폴리오"]
            },
            {
                "id": "etf_investment",
                "title": "ETF (상장지수펀드)",
                ...
                """,
                "category": "투자",
                "keywords": ["ETF", "상장지수펀드", "인덱스펀드", "패시브투자", "분산투자"]
            },
            {
                "id": "bond_investment",
                "title": "채권 투자",
                ...
                """,
                "category": "투자",
                "keywords": ["채권", "국채", "회사채", "채권펀드", "안전자산", "고정수익"]
            },
            {
                "id": "fund_investment",
                "title": "펀드 투자",
                ...
                """,
                "category": "투자",
                "keywords": ["펀드", "투자신탁", "자산운용", "액티브펀드", "패시브펀드", "분산투자"]
            },
            {
                "id": "deposit_savings",
                "title": "예금과 적금",
                ...
                """,
                "category": "저축",
                "keywords": ["예금", "적금", "정기예금", "정기적금", "자유적금", "이자"]
            },
            {
                ...
                """,
                "category": "보험",
                "keywords": ["보험", "생명보험", "손해보험", "연금보험", "종신보험", "보장"]
            },
            {
                ...
                """,
                "category": "투자",
                "keywords": ["부동산", "아파트", "오피스텔", "REITs", "부동산펀드", "임대"]
            },
            {
                "id": "cryptocurrency",
                "title": "암호화폐 투자",
                ...
                """,
                "category": "투자",
                "keywords": ["암호화폐", "비트코인", "이더리움", "가상화폐", "블록체인", "디지털자산"]
            }
        ]
    
    def initialize_knowledge_base(self):
        """지식베이스 초기화"""
        print("Initializing finance knowledge base...")
        
        # 기존 데이터 삭제
        try:
            self.chroma_client.delete_collection("finance_knowledge")
            self.collection = self.chroma_client.create_collection(
                name="finance_knowledge",
                metadata={"description": "경제 상식 지식베이스"}
            )
        ...
        print(f"Knowledge base initialized with {len(self.finance_knowledge)} items")
    ...
    def generate_answer(self, question: str) -> str:
        ...
        try:
            # 관련 지식 검색
            knowledge_items = self.query_knowledge(question, top_k=3)
